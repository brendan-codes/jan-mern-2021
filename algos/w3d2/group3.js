...
const items = [
    ...
    { firstName: "Bob", lastName: "Smith", age: 27 },
    { firstName: "Bob", lastName: "White", age: 31 },
    { firstName: "Bob", lastName: "Blue", age: 31 },
    { firstName: "Bob", lastName: "Yellow", age: 31 }
];
// console.log(Object.getOwnPropertyNames(Objects.keys(items)))

function findObjectsFilter(search, items) {
    const results = items.filter(i =>
        i.firstName.includes(search.firstName) &&
        // i.lastName.includes(search.lastName) &&
        i.age == search.age);
console.log(search.firstName,search.lastName,search.age)
  return results
}
